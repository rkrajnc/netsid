...
make sure they match your FPGA target, and the pins defined there match the
...
the UART and at a faster rate than it plays back at, the FIFO will fill up again
...
in check so the we're not writing data into the FIFO when it is full, therefore
